Feature: Forget Password feature
  ...
  Scenario Outline: Check Prompt for forget password
	...
	Examples:
		...
		|18611054037|验证码已发送至您的手机，请注意查收|||请输入短信验证码|
		|18611054037|验证码已发送至您的手机，请注意查收|1234|123566|验证码错误|
		|18611054037|验证码已发送至您的手机，请注意查收|1234||请设置登陆密码|
		|18611054037|验证码已发送至您的手机，请注意查收|1234|12345|密码格式不正确，请您输入6-16位字母和数字组合|
		|18611054037|验证码已发送至您的手机，请注意查收|1234|12345678901234567|密码格式不正确，请您输入6-16位字母和数字组合|
